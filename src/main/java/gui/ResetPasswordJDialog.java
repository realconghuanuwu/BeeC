...
public class ResetPasswordJDialog extends javax.swing.JDialog {
     ...
     */
    public ResetPasswordJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    void init() {
        ...
        setTitle("BeeC Gear - Đặt Lại Mật Khẩu");
    ...
    private void btnTakePasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTakePasswordMouseClicked
        ...
        //xử lý code
        //        if(isValidationForm()) {
            //            new AccountDAO().changePassword(Email, String.valueOf(txtconfirmPassword.getPassword()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ResetPasswordJDialog dialog = new ResetPasswordJDialog(new javax.swing.JFrame(), true);
