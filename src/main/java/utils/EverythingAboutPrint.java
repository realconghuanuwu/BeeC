 ...
 * @author huanl
 */
public class EverythingAboutPrint {
...
//    }
    ...
    public static void print(JTable tbl, String headerstr, String footerstr) {
        MessageFormat header = new MessageFormat(headerstr);
        MessageFormat footer = new MessageFormat(footerstr);
